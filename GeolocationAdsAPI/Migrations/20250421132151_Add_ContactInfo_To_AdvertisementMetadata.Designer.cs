...
namespace GeolocationAdsAPI.Migrations
{
    ...
    [Migration("20250421132151_Add_ContactInfo_To_AdvertisementMetadata")]
    partial class Add_ContactInfo_To_AdvertisementMetadata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToolsLibrary.Models.RestrictedZone", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ToolsLibrary.Models.User", b =>
                {
                    b.HasOne("ToolsLibrary.Models.AppSetting", "UserRole")
                        .WithMany()
